...
const DEFAULT_COA: ChartOfAccount[] = [
  ...
  { coaCode: '4-1004', accountName: 'Pendapatan Jasa Layanan / Penagihan Lapangan (Door-to-Door)', category: 'PENDAPATAN', subCategory: 'Pendapatan Operasional Lainnya', normalBalance: 'KREDIT', currentBalance: 3500000, active: true },
...
const DEFAULT_MEMBERS: Member[] = [
  ...
  {
    partyId: 'NAS-2026-000002',
    partyType: 'NON_ANGGOTA',
    nomorIdentitasKoperasi: 'NS-0002',
    nama: 'Usun (Nasabah Non-Anggota)',
    ...
    noHp: '085211223344',
    email: 'usun.dagang@gmail.com',
    alamat: 'Jl. Pasar Baru No. 18, Bandung',
    tanggalGabung: '2026-02-15',
    status: 'AKTIF',
    simpananPokokPaid: false,
...
const DEFAULT_LOAN_APPLICATIONS: LoanApplication[] = [
  ...
  {
    applicationId: 'PJ-2026-000004',
    contractNumber: 'AKD-2026-000004',
    partyId: 'NAS-2026-000002',
    partyName: 'Usun (Nasabah Non-Anggota)',
    partyType: 'NON_ANGGOTA',
    partyPhone: '085211223344',
    productId: 'PRD-PJ-001',
    productName: 'Pinjaman Mikro Cepat Non-Anggota',
    purpose: 'MODAL_KERJA',
    purposeNotes: 'Tambahan modal dagang harian',
    amount: 200000, // strictly multiple of 50000
    tenorMonths: 1,
    tenorCount: 1,
    tenorUnit: 'BULAN',
    tenorLabel: '1 Bulan (30 Hari)',
    interestMethod: 'FLAT',
    interestRateAnnual: 60.0, // 5% flat per bulan = 60% p.a. => Bunga Rp 10.000
    adminFee: 10000, // Biaya admin 10.000 dipotong di awal
    disbursedAmount: 190000, // 200.000 - 10.000 = 190.000 diterima
    surveyDate: '2026-08-20',
    surveyorNotes: 'Usaha warung harian di pasar, cashflow lancar',
    creditScore: 'BAIK',
    guaranteeType: 'KTP & Surat Keterangan Usaha (SKU)',
    ...
    disbursedMethod: 'KAS',
    disbursedBy: 'Siti Rahmawati',
    cashBankRefId: 'BK-2026-000004',
    journalRefId: 'JR-2026-000004',
...
const DEFAULT_SCHEDULES: InstallmentSchedule[] = [
  ...
  // Schedule for USUN (Non-Anggota) - Pinjaman Rp 200.000, Tenor 1 Bulan
  {
    installmentId: 'SCH-2026-000401',
    contractId: 'AKD-2026-000004',
    applicationId: 'PJ-2026-000004',
    partyId: 'NAS-2026-000002',
    partyName: 'Usun (Nasabah Non-Anggota)',
    installmentNo: 1,
